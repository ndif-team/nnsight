...
from vllm.model_executor.layers.linear import ColumnParallelLinear, RowParallelLinear, tensor_model_parallel_all_gather, split_tensor_along_last_dim, tensor_model_parallel_all_reduce
        ...
        def post_output_hook(module: torch.nn.Module,  args: Any, output: Any):
            ...
            if self.parallel and self.gathered:
                ...
                if isinstance(self.current_module, ColumnParallelLinear):
                    ...
                    output = apply(
                        output,
                        lambda x: x / self.current_module.tp_size,
                        torch.Tensor
                    )
