...
against the cross-stage transport. Where the failure mode of a shape is a wait
that never ends (the link's deadline), the test bounds the elapsed time well
inside that limit.
"""
