...
Contributed by [@khaiwang](https://github.com/khaiwang)!
...
- **Tensor-parallel correctness fixes:**
  - **CUDA stream propagation to TP worker threads.** Workers no longer write to the default stream while the driver computes on a side stream; this was a source of silent non-determinism on TP setups. Contributed by [@khaiwang](https://github.com/khaiwang)!
...
Contributed by [@MichaelRipa](https://github.com/MichaelRipa)!
