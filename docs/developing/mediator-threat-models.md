...
backend + §17 triton motivation), [mediator-isolation-sandbox.md](mediator-isolation-sandbox.md) (the
...
`subprocess`/ptxas/`tempfile`/`open` exactly when the whitelist denies them (see §17 of
